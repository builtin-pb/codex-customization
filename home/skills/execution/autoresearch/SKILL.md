---
name: autoresearch
description: Use only when the user explicitly asks for full autonomous research execution, such as "run autoresearch", "do full autonomous research", or "take over this research end-to-end". Do not use for ordinary research help, literature review, brainstorming, planning, or step-by-step collaboration.
version: 1.0.0
...
Use this skill only when the user explicitly delegates full autonomous research control.

Explicit activators include requests like:
- "run autoresearch"
- "do full autonomous research"
- "take over this research end-to-end"
- "work on this autonomously until you have results"

Do NOT use this skill for:
- ordinary research assistance
- literature review requests
- brainstorming or ideation help
- experiment design discussions
- paper drafting help
- collaborative, step-by-step research work

If the request is not an explicit handoff into autonomous research mode, stop and use more specific non-autonomous skills instead.
