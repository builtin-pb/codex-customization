...
This is the primary paper-writing skill in this collection. If the starting point is only a research repo or experiment directory and no manuscript exists yet, use `repo-to-paper-rough-draft` first to create the rough draft, then return here for section-level rewriting and review.
