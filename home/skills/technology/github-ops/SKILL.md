---
name: github-ops
description: Use when working with GitHub pull requests, issues, repositories, Actions workflows, or GitHub REST and GraphQL APIs via `gh` CLI in public or enterprise GitHub environments
---
...
**PR Title Convention:**
- Follow repository-specific conventions before opening the PR.
- Common patterns include ticket-prefixed titles like `ABC-123: Descriptive title` or plain titles like `Fix flaky login test`.
...
- Detailed PR creation patterns (repo-specific title conventions, body from file, targeting branches)
